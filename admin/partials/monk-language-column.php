...
<div class="monk-column-translations">
	<?php if ( $monk_language ) : ?>
		<div class="monk-flag-wrapper">
			<span class="monk-selector-flag flag-icon <?php echo esc_attr( 'flag-icon-' . strtolower( $monk_language ) ); ?>" aria-label="<?php echo esc_attr( $monk_languages[ $monk_language ]['english_name'] ); ?>" title="<?php echo esc_attr( $monk_languages[ $monk_language ]['english_name'] ); ?>"></span>
		</div>
